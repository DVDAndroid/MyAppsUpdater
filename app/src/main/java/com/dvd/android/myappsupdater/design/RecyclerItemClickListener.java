...
/**
 * Used for listening to RecyclerView item clicks. You can either implement an
 * OnItemClickListener or extend SimpleOnItemClickListener and override its
 * methods.
 *
 * Licence: MIT
 *
...
public class RecyclerItemClickListener implements
	...
	public interface OnItemClickListener {
		 ...
		 *
		 * @param childView
		 *            View of the item that was clicked.
		 * @param position
		 ...
		 *
		 * @param childView
		 *            View of the item that was long pressed.
		 * @param position
		 *            Position of the item that was long pressed.
		 */
	 ...
	 */
	public static abstract class SimpleOnItemClickListener implements
			OnItemClickListener {
